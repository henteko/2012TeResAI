...
/**********************************************************
	初期化時に呼ばれる関数
**********************************************************/
void KenkinoInit(AI_T &myAi)
{
	myAi.Graph = LoadGraph("AI_image\\サンドくん1.png");  //画像の設定
	strcpy_s(myAi.name, "Kenkino");  //自分のAIの名前設定
}
...
/**********************************************************
	AIの行動を返す関数
**********************************************************/
Action Kenkino(int view[2*VISIBLE+1][2*VISIBLE+1])
{
	int r;
	int danger=0;
	double direct;
